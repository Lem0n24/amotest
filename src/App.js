...
import StartLoad from './panels/StartLoad';
...
const App = () => {
	...
	return (
		<View activePanel={activePanel} popout={popout} modal={modalCard}>
			...
			<TimeTable id='timeTable' go={go} />
			<StartLoad id='startLoad' go={go}/>
			<script id='XLSX' src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.16.2/xlsx.full.min.js"></script>
		</View>
	);
}
