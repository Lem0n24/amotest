	...
	changeDate(e) {
		try {
			...
			console.log('Дата неверна');
				...
				//<img classNameName="Schedule" src={logo} alt="Оренбургский Государственный Университет"/>
		...
		return (
			<Panel id={this.props.id}>
				...
				<FormLayout style={{backgroundImage: 'url(./back.png)' }}>
					...
					<FormLayoutGroup>
						<Text weight="medium" style={{ marginBottom: 16, color: 'black' }}>Информация о группе</Text>
						<Select onChange={this.changeFaculty} placeholder="Корпус"
				...
				<Group title="Footer" id="footer">
					...
					<Div id="link">
						<Link href="http://www.krascollege.ru/" target="_blank">ККСУИП</Link>
					</Div>
				</Group>
				</FormLayout>
			</Panel>
